...
{(DanaType*) &byte_def, NULL, 0, 0, 81},
{(DanaType*) &byte_def, NULL, 0, 0, 82},
{(DanaType*) &byte_def, NULL, 0, 0, 83}};
...
{TYPE_FUNCTION, 0, 84, (DanaTypeField*) &function_UIPlaneLib_addTextWith_fields, 11},
