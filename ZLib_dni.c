...
((VFrameHeader*) op_deflateInit_thread_spec) -> sub = NULL;
...
((VFrameHeader*) op_deflate_thread_spec) -> sub = NULL;
...
((VFrameHeader*) op_deflateEnd_thread_spec) -> sub = NULL;
...
((VFrameHeader*) op_inflateInit_thread_spec) -> sub = NULL;
...
((VFrameHeader*) op_inflate_thread_spec) -> sub = NULL;
...
((VFrameHeader*) op_inflateStatus_thread_spec) -> sub = NULL;
...
((VFrameHeader*) op_inflateEnd_thread_spec) -> sub = NULL;
