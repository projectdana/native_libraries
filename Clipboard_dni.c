...
static const DanaTypeField function_Clipboard_clone_fields[] = {
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_Clipboard_equals_fields[] = {
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_Clipboard_toString_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_Clipboard_getID_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_Clipboard_setContent_fields[] = {
{(DanaType*) &void_def, NULL, 0, 0, 0},{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_Clipboard_getContent_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaType object_Clipboard_functions_spec[] = {
{TYPE_FUNCTION, 0, 48, (DanaTypeField*) &function_Clipboard_clone_fields, 2},
{TYPE_FUNCTION, 0, 48, (DanaTypeField*) &function_Clipboard_equals_fields, 2},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_Clipboard_toString_fields, 1},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_Clipboard_getID_fields, 1},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_Clipboard_setContent_fields, 2},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_Clipboard_getContent_fields, 1}};
static const DanaTypeField intf_functions_def[] = {
{(DanaType*) &object_Clipboard_functions_spec[0], "clone", 5},
{(DanaType*) &object_Clipboard_functions_spec[1], "equals", 6},
{(DanaType*) &object_Clipboard_functions_spec[2], "toString", 8},
{(DanaType*) &object_Clipboard_functions_spec[3], "getID", 5},
{(DanaType*) &object_Clipboard_functions_spec[4], "setContent", 10},
{(DanaType*) &object_Clipboard_functions_spec[5], "getContent", 10}};
static const DanaType Clipboard_object_spec[] = {
{TYPE_DATA, 0, 0, (DanaTypeField*) intf_functions_def, 6},
{TYPE_DATA, 0, 0, NULL, 0},
{TYPE_DATA, 0, 0, NULL, 0}
};
static const DanaTypeField intf_def[] = {
{(DanaType*) &Clipboard_object_spec[0], ".functions", 10},
{(DanaType*) &Clipboard_object_spec[1], ".events", 7},
{(DanaType*) &Clipboard_object_spec[2], ".state", 6},
};
...
static InterfaceDetails ids[] = {{"os.Clipboard", 12, &libType}};
