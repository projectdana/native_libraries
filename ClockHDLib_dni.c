...
static const DanaTypeField TimeHD_fields[] = {
{(DanaType*) &int_def, NULL, 0, 0, 0},
{(DanaType*) &int_def, NULL, 0, 0, 0+sizeof(size_t)}};
static const DanaType TimeHD_def = 
{TYPE_DATA, 0, 16, (DanaTypeField*) TimeHD_fields, 2};
static const DanaType void_def = 
{TYPE_LITERAL, 0, 0, NULL, 0};
static const DanaTypeField function_ClockHDLib_clone_fields[] = {
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_ClockHDLib_equals_fields[] = {
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_ClockHDLib_toString_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_ClockHDLib_getID_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_ClockHDLib_init_fields[] = {
{(DanaType*) &int_def, NULL, 0, 0, 0}};
static const DanaTypeField function_ClockHDLib_getTime_fields[] = {
{(DanaType*) &TimeHD_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 16}};
static const DanaTypeField function_ClockHDLib_destroy_fields[] = {
{(DanaType*) &void_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 0}};
static const DanaType object_ClockHDLib_functions_spec[] = {
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_ClockHDLib_clone_fields, 2},
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_ClockHDLib_equals_fields, 2},
{TYPE_FUNCTION, 0, 16, (DanaTypeField*) &function_ClockHDLib_toString_fields, 1},
{TYPE_FUNCTION, 0, 16, (DanaTypeField*) &function_ClockHDLib_getID_fields, 1},
{TYPE_FUNCTION, 0, 8, (DanaTypeField*) &function_ClockHDLib_init_fields, 1},
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_ClockHDLib_getTime_fields, 2},
{TYPE_FUNCTION, 0, 8, (DanaTypeField*) &function_ClockHDLib_destroy_fields, 2}};
static const DanaTypeField intf_functions_def[] = {
{(DanaType*) &object_ClockHDLib_functions_spec[0], "clone", 5},
{(DanaType*) &object_ClockHDLib_functions_spec[1], "equals", 6},
{(DanaType*) &object_ClockHDLib_functions_spec[2], "toString", 8},
{(DanaType*) &object_ClockHDLib_functions_spec[3], "getID", 5},
{(DanaType*) &object_ClockHDLib_functions_spec[4], "init", 4},
{(DanaType*) &object_ClockHDLib_functions_spec[5], "getTime", 7},
{(DanaType*) &object_ClockHDLib_functions_spec[6], "destroy", 7}};
static const DanaTypeField intf_events_def[] = {
};
static const DanaType ClockHDLib_object_spec[] = {
...
{(DanaType*) &ClockHDLib_object_spec[0], ".functions", 10},
{(DanaType*) &ClockHDLib_object_spec[1], ".events", 7},
{(DanaType*) &ClockHDLib_object_spec[2], ".state", 6},
};
...
static unsigned char op_getTime_thread_spec[sizeof(VFrameHeader)+sizeof(VFrame)];
...
((VFrameHeader*) op_clone_thread_spec) -> localsDef = (size_t) &object_ClockHDLib_functions_spec[0];
...
((VFrameHeader*) op_equals_thread_spec) -> localsDef = (size_t) &object_ClockHDLib_functions_spec[1];
...
((VFrameHeader*) op_toString_thread_spec) -> localsDef = (size_t) &object_ClockHDLib_functions_spec[2];
...
((VFrameHeader*) op_getID_thread_spec) -> localsDef = (size_t) &object_ClockHDLib_functions_spec[3];
...
((VFrameHeader*) op_init_thread_spec) -> localsDef = (size_t) &object_ClockHDLib_functions_spec[4];
((VFrameHeader*) op_init_thread_spec) -> functionName = "init";
((VFrameHeader*) op_getTime_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 24;
((VFrameHeader*) op_getTime_thread_spec) -> formalParamsCount = 1;
((VFrameHeader*) op_getTime_thread_spec) -> sub = NULL;
((VFrameHeader*) op_getTime_thread_spec) -> localsDef = (size_t) &object_ClockHDLib_functions_spec[5];
((VFrameHeader*) op_getTime_thread_spec) -> functionName = "getTime";
...
((VFrameHeader*) op_destroy_thread_spec) -> localsDef = (size_t) &object_ClockHDLib_functions_spec[6];
...
{"getTime", (VFrameHeader*) op_getTime_thread_spec},
