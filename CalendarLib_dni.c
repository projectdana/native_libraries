...
static const DanaTypeField function_CalendarLib_getMS_fields[] = {
{(DanaType*) &int_def, NULL, 0, 0, 0}};
static const DanaType object_CalendarLib_functions_spec[] = {
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_CalendarLib_clone_fields, 2},
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_CalendarLib_equals_fields, 2},
{TYPE_FUNCTION, 0, 16, (DanaTypeField*) &function_CalendarLib_toString_fields, 1},
{TYPE_FUNCTION, 0, 16, (DanaTypeField*) &function_CalendarLib_getID_fields, 1},
{TYPE_FUNCTION, 0, 16, (DanaTypeField*) &function_CalendarLib_getLocalTime_fields, 2},
{TYPE_FUNCTION, 0, 8, (DanaTypeField*) &function_CalendarLib_getMS_fields, 1}};
...
{(DanaType*) &object_CalendarLib_functions_spec[5], "getMS", 5}};
static const DanaType object_CalendarLib_events_spec[] = {
};
...
static unsigned char op_getMS_thread_spec[sizeof(VFrameHeader)+sizeof(VFrame)];
...
((VFrameHeader*) op_getLocalTime_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 16;
((VFrameHeader*) op_getLocalTime_thread_spec) -> formalParamsCount = 1;
((VFrameHeader*) op_getLocalTime_thread_spec) -> sub = NULL;
...
((VFrameHeader*) op_getMS_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 8;
((VFrameHeader*) op_getMS_thread_spec) -> formalParamsCount = 0;
((VFrameHeader*) op_getMS_thread_spec) -> sub = NULL;
((VFrameHeader*) op_getMS_thread_spec) -> localsDef = (size_t) &object_CalendarLib_functions_spec[5];
((VFrameHeader*) op_getMS_thread_spec) -> functionName = "getMS";
...
{"getMS", (VFrameHeader*) op_getMS_thread_spec}};
