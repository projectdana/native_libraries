...
static const DanaTypeField function_SemaphoreLib_clone_fields[] = {
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_SemaphoreLib_equals_fields[] = {
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_SemaphoreLib_toString_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_SemaphoreLib_getID_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_SemaphoreLib_newInstance_fields[] = {
{(DanaType*) &int_def, NULL, 0, 0, 0}};
static const DanaTypeField function_SemaphoreLib_wait_fields[] = {
{(DanaType*) &void_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 0}};
static const DanaTypeField function_SemaphoreLib_signal_fields[] = {
{(DanaType*) &void_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 0}};
static const DanaTypeField function_SemaphoreLib_destroy_fields[] = {
{(DanaType*) &void_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 0}};
static const DanaType object_SemaphoreLib_functions_spec[] = {
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_SemaphoreLib_clone_fields, 2},
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_SemaphoreLib_equals_fields, 2},
{TYPE_FUNCTION, 0, 16, (DanaTypeField*) &function_SemaphoreLib_toString_fields, 1},
{TYPE_FUNCTION, 0, 16, (DanaTypeField*) &function_SemaphoreLib_getID_fields, 1},
{TYPE_FUNCTION, 0, 8, (DanaTypeField*) &function_SemaphoreLib_newInstance_fields, 1},
{TYPE_FUNCTION, 0, 8, (DanaTypeField*) &function_SemaphoreLib_wait_fields, 2},
{TYPE_FUNCTION, 0, 8, (DanaTypeField*) &function_SemaphoreLib_signal_fields, 2},
{TYPE_FUNCTION, 0, 8, (DanaTypeField*) &function_SemaphoreLib_destroy_fields, 2}};
static const DanaTypeField intf_functions_def[] = {
{(DanaType*) &object_SemaphoreLib_functions_spec[0], "clone", 5},
{(DanaType*) &object_SemaphoreLib_functions_spec[1], "equals", 6},
{(DanaType*) &object_SemaphoreLib_functions_spec[2], "toString", 8},
{(DanaType*) &object_SemaphoreLib_functions_spec[3], "getID", 5},
{(DanaType*) &object_SemaphoreLib_functions_spec[4], "newInstance", 11},
{(DanaType*) &object_SemaphoreLib_functions_spec[5], "wait", 4},
{(DanaType*) &object_SemaphoreLib_functions_spec[6], "signal", 6},
{(DanaType*) &object_SemaphoreLib_functions_spec[7], "destroy", 7}};
static const DanaTypeField intf_events_def[] = {
};
static const DanaType SemaphoreLib_object_spec[] = {
...
{(DanaType*) &SemaphoreLib_object_spec[0], ".functions", 10},
{(DanaType*) &SemaphoreLib_object_spec[1], ".events", 7},
{(DanaType*) &SemaphoreLib_object_spec[2], ".state", 6},
};
...
static unsigned char op_newInstance_thread_spec[sizeof(VFrameHeader)+sizeof(VFrame)];
static unsigned char op_wait_thread_spec[sizeof(VFrameHeader)+sizeof(VFrame)];
static unsigned char op_signal_thread_spec[sizeof(VFrameHeader)+sizeof(VFrame)];
static unsigned char op_destroy_thread_spec[sizeof(VFrameHeader)+sizeof(VFrame)];
...
(size_t) op_newInstance_thread_spec,
(size_t) op_wait_thread_spec,
(size_t) op_signal_thread_spec,
(size_t) op_destroy_thread_spec};
static DanaType libType = {TYPE_OBJECT, 0, 0, (DanaTypeField*) intf_def, 3};
static InterfaceDetails ids[] = {{"SemaphoreLib", 12, &libType}};
...
((VFrameHeader*) op_clone_thread_spec) -> localsDef = (size_t) &object_SemaphoreLib_functions_spec[0];
...
((VFrameHeader*) op_equals_thread_spec) -> localsDef = (size_t) &object_SemaphoreLib_functions_spec[1];
...
((VFrameHeader*) op_toString_thread_spec) -> localsDef = (size_t) &object_SemaphoreLib_functions_spec[2];
...
((VFrameHeader*) op_getID_thread_spec) -> localsDef = (size_t) &object_SemaphoreLib_functions_spec[3];
((VFrameHeader*) op_getID_thread_spec) -> functionName = "getID";
((VFrameHeader*) op_newInstance_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 8;
((VFrameHeader*) op_newInstance_thread_spec) -> formalParamsCount = 0;
((VFrameHeader*) op_newInstance_thread_spec) -> sub = NULL;
((VFrameHeader*) op_newInstance_thread_spec) -> localsDef = (size_t) &object_SemaphoreLib_functions_spec[4];
((VFrameHeader*) op_newInstance_thread_spec) -> functionName = "newInstance";
((VFrameHeader*) op_wait_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 8;
((VFrameHeader*) op_wait_thread_spec) -> formalParamsCount = 1;
((VFrameHeader*) op_wait_thread_spec) -> sub = NULL;
((VFrameHeader*) op_wait_thread_spec) -> localsDef = (size_t) &object_SemaphoreLib_functions_spec[5];
((VFrameHeader*) op_wait_thread_spec) -> functionName = "wait";
((VFrameHeader*) op_signal_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 8;
((VFrameHeader*) op_signal_thread_spec) -> formalParamsCount = 1;
((VFrameHeader*) op_signal_thread_spec) -> sub = NULL;
((VFrameHeader*) op_signal_thread_spec) -> localsDef = (size_t) &object_SemaphoreLib_functions_spec[6];
((VFrameHeader*) op_signal_thread_spec) -> functionName = "signal";
((VFrameHeader*) op_destroy_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 8;
((VFrameHeader*) op_destroy_thread_spec) -> formalParamsCount = 1;
((VFrameHeader*) op_destroy_thread_spec) -> sub = NULL;
((VFrameHeader*) op_destroy_thread_spec) -> localsDef = (size_t) &object_SemaphoreLib_functions_spec[7];
((VFrameHeader*) op_destroy_thread_spec) -> functionName = "destroy";
...
{"newInstance", (VFrameHeader*) op_newInstance_thread_spec},
{"wait", (VFrameHeader*) op_wait_thread_spec},
{"signal", (VFrameHeader*) op_signal_thread_spec},
{"destroy", (VFrameHeader*) op_destroy_thread_spec}};
