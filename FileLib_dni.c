...
{TYPE_DATA, 0, 16, (DanaTypeField*) FileEntry_fields, 1};
...
{TYPE_DATA, 0, 16, (DanaTypeField*) DCQ_fields, 1};
...
{TYPE_DATA, 0, 32, (DanaTypeField*) FileInfo_fields, 3};
...
{(DanaType*) &DCQ_def, NULL, 0, 0, 16}};
static const DanaTypeField function_FileLib_getInfo_fields[] = {
{(DanaType*) &void_def, NULL, 0, 0, 0},{(DanaType*) &char_array_def, NULL, 0, 0, 0},
{(DanaType*) &FileInfo_def, NULL, 0, 0, 16}};
...
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_FileLib_clone_fields, 2},
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_FileLib_equals_fields, 2},
{TYPE_FUNCTION, 0, 16, (DanaTypeField*) &function_FileLib_toString_fields, 1},
{TYPE_FUNCTION, 0, 16, (DanaTypeField*) &function_FileLib_getID_fields, 1},
{TYPE_FUNCTION, 0, 25, (DanaTypeField*) &function_FileLib_open_fields, 3},
{TYPE_FUNCTION, 0, 32, (DanaTypeField*) &function_FileLib_write_fields, 3},
{TYPE_FUNCTION, 0, 32, (DanaTypeField*) &function_FileLib_read_fields, 3},
...
{TYPE_FUNCTION, 0, 32, (DanaTypeField*) &function_FileLib_getDirectoryContents_fields, 3},
{TYPE_FUNCTION, 0, 32, (DanaTypeField*) &function_FileLib_getInfo_fields, 3},
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_FileLib_exists_fields, 2},
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_FileLib_delete_fields, 2},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_FileLib_move_fields, 3},
{TYPE_FUNCTION, 0, 41, (DanaTypeField*) &function_FileLib_copy_fields, 4},
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_FileLib_createDirectory_fields, 2},
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_FileLib_deleteDirectory_fields, 2},
{TYPE_FUNCTION, 0, 32, (DanaTypeField*) &function_FileLib_getFullPath_fields, 2}};
...
((VFrameHeader*) op_open_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 25;
...
((VFrameHeader*) op_getDirectoryContents_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 32;
...
((VFrameHeader*) op_getInfo_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 32;
...
((VFrameHeader*) op_exists_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 24;
...
((VFrameHeader*) op_delete_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 24;
...
((VFrameHeader*) op_move_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 40;
...
((VFrameHeader*) op_copy_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 41;
...
((VFrameHeader*) op_createDirectory_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 24;
...
((VFrameHeader*) op_deleteDirectory_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 24;
...
((VFrameHeader*) op_getFullPath_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 32;
